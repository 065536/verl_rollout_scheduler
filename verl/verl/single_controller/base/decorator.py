...
# Register bin packing dispatch mode if available
try:
    ...
    Dispatch.register("BIN_PACKING_DP_COMPUTE_PROTO")
    DISPATCH_MODE_FN_REGISTRY[Dispatch.BIN_PACKING_DP_COMPUTE_PROTO] = {
        "dispatch_fn": dispatch_bin_packing_data_proto,
        "collect_fn": collect_dp_compute_data_proto,
    }
except ImportError:
    pass
